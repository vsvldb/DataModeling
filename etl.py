...
def process_log_file(cur, filepath):
    ...
    for index, row in df.iterrows():        
        ...
        print("PREPARE FOR INSERT INTO songplay_data")
...
def main():
    conn = psycopg2.connect("host=127.0.0.1 dbname=sparkifydb user=postgres password=1")
    cur = conn.cursor()
    
    print("prepare for song_data pipeline")
    process_data(cur, conn, filepath='data/song_data', func=process_song_file)
    
    print("prepare for log_data pipeline")
